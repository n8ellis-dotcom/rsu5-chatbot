...
if START_INDEX == 0:
    ...
    print('Resuming from index %d' % START_INDEX)
...
cur.close()
conn.close()
print('Done! %d chunks loaded. %d errors. Processed files %d to %d.' % (total_chunks, errors, START_INDEX, min(END_INDEX, len(all_files))-1))
